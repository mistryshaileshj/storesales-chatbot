...
# Name of the SQL Server table/view that holds the retail sales rows. It must
# expose the columns referenced below (Store, state_name, Ctr_Name, PDoc_No,
# DOC_DT, Trj_Type, qty, rtn_qty, NetItmAmt, taxable_amt, purrate, ...). Set this
# to your actual table/view name.
TABLE = "DailySalesSummary_dash"
